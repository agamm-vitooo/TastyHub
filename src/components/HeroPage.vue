<template>
  <section id="hero-page" class="overflow-hidden bg-gray-100 sm:grid sm:grid-cols-2 sm:items-center">
    ...
    <img
      alt="Violin"
      src="https://images.unsplash.com/photo-1695653422543-7da6d6744364?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
